...
import DesignCommentary from "./components/DesignCommentary";
        ...
        <main>
          ...
          <section className="limited-width">
            <h2 className="section-title">
              A workflow experience like no other.
            </h2>

            <ContentImageCard src={volumeImg} alt={"Slide to change volume"}>
              <h3 className="card-title">A desktop built around you</h3>
              <p>
                The Pixel Base integrates with all of Google to help you with
                your daily tasks. Always stay up to date with what's happening
                in your circles with a better ease of access to Google Calendar,
                Tasks, and Keep.
              </p>
              <p>
                Pairing your Pixel devices and smart home devices to the Pixel
            ...
            >
              ...
              <p>
                The Pixel Base can connect to cloud PCs and let you use them as
                if you were right there next to them. Connect to PCs in your
                Google Workspace for a private, secure experience tailored to
                your workflow.
              </p>
            </ContentImageCard>
            ...
            <DealCard src={monospaceIcon} href="https://idx.dev">
              ...
              <p>
                Stay ahead of the curve. Access Google's next-gen AI code agents
                in preview, plus get 10 more workspaces to set up projects in.
              </p>
            </DealCard>
          </section>
          ...
          <section className="limited-width-big">
            <h2 className="section-title">
              Experience <span className="gemini-text">Gemini</span> in a whole
              new way
            </h2>
              ...
              <div className="highlight gemini-highlight">
                <p>
                  ...
                  <span className="cheater-linebreak-styles">
                    Be one of the first to experience Project Mariner on
                    Desktop. Let Pixel Base automate your system tasks.
                  </span>
                </p>
